...
namespace FSH.BlazorWebAssembly.Client.Infrastructure.ApiClient
{
    ...
    public partial interface INativesClient : IApiService
    {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> GenerateRandomAsync(int nseed);
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> GenerateRandomAsync(int nseed, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class NativesClient : INativesClient
    {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> GenerateRandomAsync(int nseed)
        {
            return GenerateRandomAsync(nseed, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> GenerateRandomAsync(int nseed, System.Threading.CancellationToken cancellationToken)
        {
            if (nseed == null)
                throw new System.ArgumentNullException("nseed");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/v1/natives/generate/{nseed}");
            urlBuilder_.Replace("{nseed}", System.Uri.EscapeDataString(ConvertToString(nseed, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class StatsDto
    {
        ...
        [Newtonsoft.Json.JsonProperty("dataEnterSumBarFinSupportChart", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<ChartSeries> DataEnterSumBarFinSupportChart { get; set; } = default!;
